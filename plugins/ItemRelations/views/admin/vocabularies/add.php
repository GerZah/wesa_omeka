...
?>
<form method="post" action="<?php echo url('item-relations/vocabularies/browse', array('newVocabularyName' => @$_GET['vocabulary_name'], 'newVocabularyDescription' => @$_GET['vocabulary_description'])); ?>">
