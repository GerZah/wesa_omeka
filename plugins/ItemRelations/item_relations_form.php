    ...
    <tbody>
      <?php foreach ($subjectRelations as $subjectRelation): ?>
        <tr class="item-relations-entry">
          ...
          <?php if ($provideRelationComments): ?><td><input name="item_relations_subject_comment[]" id="item_relations_subject_comment_<?php echo $subjectRelation['item_relation_id']; ?>" size="10" maxlength="60" value="<?php echo $subjectRelation['relation_comment'];  ?>" /></td><?php endif; ?>
