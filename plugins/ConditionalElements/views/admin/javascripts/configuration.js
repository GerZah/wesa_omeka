...
(function ($) {
     ...
     */
    Configuration.enableSorting = function () {
        $('.sortable').sortable({
            items: 'li.element',
     ...
     */
    Configuration.addHideButtons = function () {
     ...
     */
    Configuration.manageItemTypes = function (addNewRequestUrl, addExistingRequestUrl, changeExistingElementUrl) {
        /**
