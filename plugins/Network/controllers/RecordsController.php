...
class Network_RecordsController extends Network_Controller_Rest
{
    ...
    {
        $this->_helper->db->setDefaultModelName('NetworkRecord');
        $this->_exhibits = $this->_helper->db->getTable('NetworkExhibit');
        $this->_records  = $this->_helper->db->getTable('NetworkRecord');
        parent::init();
    }
