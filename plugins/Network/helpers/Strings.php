...
function in_getStrings($file)
{
    ...
    array_walk_recursive($strings, 'in_translate');
 ...
 */
function in_getInputModals()
{

    $docs = array();

    // Walk all Markdown files.
    foreach (glob(IN_DIR.'/docs/html/*.html') as $file) {
